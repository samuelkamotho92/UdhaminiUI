                    ...
                    mydata?.status ? (
                        <>
                            ...
                            <div className="mockup-code md:w-1/2 md:ml-auto mx-auto ">
                                ...
                                <pre data-prefix="1" className="bg-warning text-warning-content"><code>{mydata?.message}</code></pre>
                                <pre data-prefix="$"><code>Hello! Welcome..</code></pre>
                                <pre data-prefix=">" className="text-warning"><code>click the button below to upgrade your tier...</code></pre>
                                <pre data-prefix=">" className="text-success"><code><label htmlFor="my-modal-3" className="btn btn-outline btn-sm mt-2 btn-accent">Upgrade Your Tier</label></code></pre>
                            </div>
