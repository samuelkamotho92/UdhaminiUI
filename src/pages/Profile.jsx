  ...
  return (
    <div className='flex flex-row mt-60px h-screen bg-base-200 '>
      ...
      <main className='container  grid md:grid-cols-3 sm:grid-cols-1 gap-5 justify-center items-center h-screen mx-2 mb-3'>
        ...
        <button
          onClick={() => setProfileToggle(profileToggle ? false : true)}
                  ...
                  <div className="">
                    <div className="card ">
                      <div className="card-body">
                        <label className="label">Username: ➡ {user?.fullname}</label>
                        ...
                        <label className="label">Password ➡ Not displayed</label>
                        ...
                        <label className="label">Country of residence ➡ {user?.country}</label>
                    ...
                    <div className="card ">
                      ...
                      <div className="card-body md:flex-row sm:flex-col lg:flex-row">
                        <div>
                          <input type="hidden" {...register("id")} value={user?._id} className="hidden" />

                          <label className="label"><span className="label-text">Full Names ➡{user?.username}</span></label>
                          ...
                          <label className="label"><span className="label-text">Age  ➡{user?.age}</span></label>
                          ...
                          <label className="label"><span className="label-text">GPA  ➡{user?.gpa}</span></label>
                        ...
                        <div className='md:ml-4 lg:ml-4'>
                          <label className="label">Gender  ➡{user?.gender}</label>
                          ...
                          <label className="label">Education level  ➡ {user?.education_level}</label>
