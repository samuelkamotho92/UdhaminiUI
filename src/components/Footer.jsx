...
function Footer() {
  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      <div className="items-center grid-flow-col xs:justify-self-center">
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end xs:justify-self-center">
